...
namespace GeneTrail
{
	class GT2_EXPORT Matrix
	{
		public:
			 ...
			 */
			Matrix(const std::vector<std::string>&  rows, const std::vector<std::string>&  cols);

			/**
			 * @see Matrix(const std::vector<std::string>&, const std::vector<std::string>&)
			 */
			Matrix(std::vector<std::string>&& rows, const std::vector<std::string>&  cols);

			/**
			 * @see Matrix(const std::vector<std::string>&, const std::vector<std::string>&)
			 */
			Matrix(const std::vector<std::string>&  rows, std::vector<std::string>&& cols);
